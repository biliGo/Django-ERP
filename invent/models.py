...
class InOutDetail(models.Model):
    ...
    material = models.ForeignKey(Material,verbose_name=_("material"),limit_choices_to={"is_virtual":"0"},on_delete=models.CASCADE,blank=True,null=True)
...
class InItem(InOutDetail):
    ...
    po_item = models.ForeignKey(POItem,verbose_name=_("po item"),on_delete=models.CASCADE,blank=True,null=True)
...
class OutItem(InOutDetail):
    ...
    inventory = models.ForeignKey(Inventory,blank=True,on_delete=models.CASCADE,null=True,verbose_name=_("inventory material"))
...
class ReturnItem(InOutDetail):
    ...
    out_item = models.ForeignKey(OutItem,blank=True,on_delete=models.CASCADE,null=True,verbose_name=_('out item'))
