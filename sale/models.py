...
class SaleOrder(generic.BO):
    ...
    user = models.ForeignKey(User,verbose_name=_("sales man"),on_delete=models.CASCADE,blank=True,null=True)
...
class SaleItem(models.Model):
    ...
    material = models.ForeignKey(Material,verbose_name=_("material"),on_delete=models.CASCADE,limit_choices_to={"is_virtual":"0",'can_sale':'1'},blank=True,null=True)
    measure = models.ForeignKey(Measure,verbose_name=_("measure"),on_delete=models.CASCADE,blank=True,null=True)
...
class PaymentCollection(generic.BO):
    ...
    bank = models.ForeignKey(BankAccount,verbose_name=_("bank account"),on_delete=models.CASCADE,blank=True,null=True)
...
class OfferSheet(generic.BO):
    ...
    code = models.CharField(_("code"),max_length=const.DB_CHAR_NAME_20,blank=True,null=True)
    partner = models.ForeignKey(Partner,verbose_name=_("partner"),on_delete=models.CASCADE,limit_choices_to={"partner_type":"C"})
    ...
    amount = models.DecimalField(_("money amount"),max_digits=12,decimal_places=2,blank=True,null=True,default=0.00)
    discount_amount = models.DecimalField(_("discount amount"),max_digits=12,decimal_places=2,blank=True,null=True,default=0.00)
    user = models.ForeignKey(User,verbose_name=_("offer man"),on_delete=models.CASCADE,blank=True,null=True)
